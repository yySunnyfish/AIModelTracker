-- ============================================
-- ModelTrack 整合 Schema v2.0
-- 创建时间: 2026-03-25
-- 整合内容: schema.sql + benchmark_categories.sql
-- ============================================
...
CREATE TABLE benchmarks (
  ...
  official_url TEXT,
  paper_url TEXT,
  benchmark_source VARCHAR, -- 'official', 'community', 'research', 'vendor'
...
CREATE TABLE model_benchmarks (
  ...
  -- 额外字段（来自 benchmark_categories.sql）
...
CREATE TABLE profiles (
  ...
  notification_channels alert_channel[] DEFAULT ARRAY['email'],
...
CREATE TABLE alert_rules (
  ...
  channels alert_channel[] DEFAULT ARRAY['email', 'wechat'],
  target_roles user_role[] DEFAULT ARRAY['admin', 'tech', 'exec'],
...
COMMENT ON TABLE benchmarks IS 'Benchmark 定义表，关联分类体系';
